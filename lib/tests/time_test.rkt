...
(module+ test
  ...
  (check-equal? (days->dm 1) "01.01")
  (check-equal? (days->dm 34) "03.02")
  (check-equal? (days->dm 60) "01.03")
  (check-equal? (days->dm 90) "31.03")
  (check-equal? (days->dm 91) "01.04")
  (check-equal? (days->dm 318) "14.11")
  (check-equal? (days->dm 319 #t) "14.11")
  (check-equal? (days->dm 60 #t) "29.02")
  (check-equal? (days->dm 59 #t) "28.02")
