...
(check-false (simple-cons? (cons 1 (cons 2 3))))
(check-false (simple-cons? (cons (cons 1 2) 3)))
(check-false (simple-cons? (list 1 2 3)))
(check-false (simple-cons? (list 1 2)))
(check-false (simple-cons? (list 1)))
(check-false (simple-cons? (list)))
...
(check-equal? (type (list (cons 1 2) (cons 3 4))) 'clist)
...
(check-equal? (type (cons 1 2)) 'simple-cons)
...
(check-true (equal*? 3 (- 4 1)))
(check-true (equal*? 3 "3"))
(check-true (equal*? 'a "a"))
(check-false (equal*? 'a 'b))
(check-false (equal*? 'a 'ab))
(check-false (equal*? "hello" "world"))
